const NewsLetter = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center text-center space-y-2 mt-24 pb-14" >
            <h1 className="md:text-4xl text-2xl font-semibold">Jangan Sampai Ketinggalan Promo!</h1>
            <p className="md:text-lg text-gray-500/70 pb-8">
                Berlangganan sekarang dan nikmati penawaran terbaru, produk segar, serta diskon khusus hanya untuk Anda
            </p>
